...
namespace ITD.OOP1.Ludo
{
    ...
    public class Game : IGame
    {
        ...
        {
            Console.WriteLine("Ludo Game Started!");
            board.InitializeBoard(this.players.Length, 4); // Assuming 4 players for this example
            board.DisplayBoard();
        }
        ...
        private void TakeTurns(){
            ...
            while(this.state == GameState.InPlay){
                ...
                WriteLine("", delay);
                board2.DisplayBoard();
                Console.WriteLine($"posisi {board2.GetPlayerPiecePosition(myTurn.GetPlayerId(), pieceNumber1)}");
                ...
                do
                {
                    ...
                    switch (userInput)
                    {
                        case "1":
                            ...
                            Console.WriteLine($"Token is now in ID: {(playerNumber, pieceNumber1, diceResult)}");
                            Console.WriteLine($"Jumlah Pemain: {this.players.Length}");
                            Console.WriteLine($"Get {board2.GetPlayerPiecePosition(playerNumber, pieceNumber1)}");
                            board2.InitializeBoard(this.players.Length,4);
                            board2.MovePlayerPiece(playerNumber, pieceNumber1, diceResult);
                            board2.GetPlayerPiecePosition(playerNumber, pieceNumber1);
                            //board2.EliminatePlayer(playerNumber);
                        ...
                        case "2":
                            ...
                            board2.InitializeBoard(this.players.Length, 4);
                            board2.MovePlayerPiece(playerNumber, pieceNumber2, diceResult);

                            //board2.EliminatePlayer(playerNumber);
                            board2.GetPlayerPiecePosition(playerNumber, pieceNumber2);
                            board2.DisplayBoard();
                            this.NotChangeTurn();
                            break;
                        ...
                        case "3":
                            ...
                            board2.InitializeBoard(this.players.Length, 4);
                            board2.InitializeBoard(this.players.Length, 4);
                            board2.MovePlayerPiece(playerNumber, pieceNumber3, diceResult);

                            //board2.EliminatePlayer(playerNumber);
                            board2.GetPlayerPiecePosition(playerNumber, pieceNumber3);
                            board2.DisplayBoard();
                            this.NotChangeTurn();
                            break;
                        ...
                        case "4":
                            ...
                            board2.InitializeBoard(this.players.Length, 4);
                            board2.InitializeBoard(this.players.Length, 4);
                            board2.MovePlayerPiece(playerNumber, pieceNumber4, diceResult);
